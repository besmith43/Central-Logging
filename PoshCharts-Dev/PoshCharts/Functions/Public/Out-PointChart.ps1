Function Out-PointChart {
    <#
        ...
        .EXAMPLE
            ...
            Select-Object -First 10 | Out-PointChart -XField Name `
        ...
        .EXAMPLE
            ...
            @($Process1,$Process2) | Out-PointChart -XField Name `
        ...
        .EXAMPLE
            ...
            Sort PercentProcessorTime -Descending  | Select -First 10 | 
            Out-PointChart -XField Name -YField PercentProcessorTime -Title 'Top 10 Processes By CPU Usage (if applicable)' -IncludeLegend
    #>
    [cmdletbinding(
    ...
    End {
        If ($Data[0] -is [array]) {
            ...
            ForEach ($Item in $Data) {
                ...
                $Series.ChartType = $ChartTypes::Point
                $Chart.Series.Add($Series)            
                #region MSChart Build
                $Chart.Series[$SeriesLabel].Points.DataBindXY($HashTable.Keys, $HashTable.Values)
                $Chart.Series[$SeriesLabel]['PointLabelStyle'] = 'Outside'
                $Chart.Series[$SeriesLabel].MarkerSize = 10
        ...
        Else {
            ...
            $Chart.Series['Series1']['PointLabelStyle'] = 'Outside'
