Function Out-BubbleChart {
    <#
        ...
        .EXAMPLE
            ...
            Select-Object -First 10 | Out-BubbleChart -XField Name `
        ...
        .EXAMPLE
            ...
            @($Process1,$Process2) | Out-BubbleChart -XField Name `
        ...
        .EXAMPLE
            ...
            Sort PercentProcessorTime -Descending  | Select -First 10 | 
            Out-BubbleChart -XField Name -YField PercentProcessorTime -Title 'Top 10 Processes By CPU Usage (if applicable)' -IncludeLegend
    #>
    [cmdletbinding(
    ...
    End {
        ...
        Else {
            ...
            $Chart.Series['Series1']['BubbleLabelStyle'] = 'Outside'
