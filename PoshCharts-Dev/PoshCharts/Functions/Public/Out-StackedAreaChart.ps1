Function Out-StackedAreaChart {
    <#
        ...
        .EXAMPLE
            ...
            Select-Object -First 10 | Out-StackedAreaChart -XField Name `
        ...
        .EXAMPLE
            ...
            @($Process1,$Process2) | Out-StackedAreaChart -XField Name `
        ...
        .EXAMPLE
            ...
            Sort PercentProcessorTime -Descending  | Select -First 10 | 
            Out-StackedAreaChart -XField Name -YField PercentProcessorTime -Title 'Top 10 Processes By CPU Usage (if applicable)' -IncludeLegend
    #>
    [cmdletbinding(
    ...
    End {
        If ($Data[0] -is [array]) {
            ...
            ForEach ($Item in $Data) {
                ...
                $Series.ChartType = $ChartTypes::StackedArea
