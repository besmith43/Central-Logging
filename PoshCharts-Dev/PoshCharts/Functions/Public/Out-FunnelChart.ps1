Function Out-FunnelChart {
    <#
        ...
        .EXAMPLE
            ...
            Select-Object -First 20 | Out-FunnelChart -XField Name -YField WS `
        ...
        .EXAMPLE
            ...
            Out-FunnelChart -XField Name -YField PercentProcessorTime -Title 'Top 10 Processes By CPU Usage (if applicable)'
    #>
    [cmdletbinding(
    ...
    Begin {
        ...
        $Series.ChartType = $ChartTypes::Funnel
