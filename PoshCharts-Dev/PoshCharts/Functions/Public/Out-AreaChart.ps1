Function Out-AreaChart {
    <#
        ...
        .EXAMPLE
            ...
            Select-Object -First 10 | Out-AreaChart -XField Name `
        ...
        .EXAMPLE
            ...
            @($Process1,$Process2) | Out-AreaChart -XField Name `
        ...
        .EXAMPLE
            ...
            Sort PercentProcessorTime -Descending  | Select -First 10 | 
            Out-AreaChart -XField Name -YField PercentProcessorTime -Title 'Top 10 Processes By CPU Usage (if applicable)' -IncludeLegend
    #>
    [cmdletbinding(
    ...
    End {
        If ($Data[0] -is [array]) {
            ...
            ForEach ($Item in $Data) {
                ...
                $Series.ChartType = $ChartTypes::Area
