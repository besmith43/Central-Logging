Function Out-KagiChart {
    <#
        ...
        .EXAMPLE
            ...
            Select-Object -First 10 | Out-KagiChart -XField Name `
        ...
        .EXAMPLE
            ...
            Out-KagiChart -XField Name -YField PercentProcessorTime -Title 'Top 10 Processes By CPU Usage (if applicable)' -IncludeLegend
    #>
    [cmdletbinding(
    ...
    Begin {
        ...
        $Series.ChartType = $ChartTypes::Kagi
