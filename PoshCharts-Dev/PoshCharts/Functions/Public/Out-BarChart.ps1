Function Out-BarChart {
    <#
        ...
        .EXAMPLE
            ...
            Select-Object -First 10 | Out-BarChart -XField Name `
        ...
        .EXAMPLE
            ...
            @($Process1,$Process2) | Out-BarChart -XField Name `
        ...
        .EXAMPLE
            ...
            Sort PercentProcessorTime -Descending  | Select -First 10 | 
            Out-BarChart -XField Name -YField PercentProcessorTime -Title 'Top 10 Processes By CPU Usage (if applicable)' -IncludeLegend
    #>
    [cmdletbinding(
