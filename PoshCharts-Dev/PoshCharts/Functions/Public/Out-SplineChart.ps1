Function Out-SplineChart {
    <#
        ...
        .EXAMPLE
            ...
            Select-Object -First 10 | Out-SplineChart -XField Name `
        ...
        .EXAMPLE
            ...
            @($Process1,$Process2) | Out-SplineChart -XField Name `
        ...
        .EXAMPLE
            ...
            Sort PercentProcessorTime -Descending  | Select -First 10 | 
            Out-SplineChart -XField Name -YField PercentProcessorTime -Title 'Top 10 Processes By CPU Usage (if applicable)' -IncludeLegend
    #>
    [cmdletbinding(
    ...
    End {
        ...
        Else {
            ...
            $Chart.Series['Series1']['SplineLabelStyle'] = 'Outside'
