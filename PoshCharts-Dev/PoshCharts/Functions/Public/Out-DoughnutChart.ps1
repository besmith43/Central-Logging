Function Out-DoughnutChart {
    <#
        ...
        .EXAMPLE
            ...
            Select-Object -First 20 | Out-DoughnutChart -XField Name -YField WS -Title 'Top 20 Processes By Working Set Memory' -Enable3D
        ...
        .EXAMPLE
            ...
            Out-DoughnutChart -XField Name -YField PercentProcessorTime -Title 'Top 10 Processes By CPU Usage (if applicable)'
    #>
    [cmdletbinding(
    ...
    Begin {
        ...
        $Series.ChartType = $ChartTypes::Doughnut
