Function Out-CandleStickChart {
    <#
        ...
        .EXAMPLE
            ...
            Select-Object -First 10 | Out-CandleStickChart -XField Name `
        ...
        .EXAMPLE
            ...
            @($Process1,$Process2) | Out-CandleStickChart -XField Name `
        ...
        .EXAMPLE
            ...
            Sort PercentProcessorTime -Descending  | Select -First 10 | 
            Out-CandleStickChart -XField Name -YField PercentProcessorTime -Title 'Top 10 Processes By CPU Usage (if applicable)' -IncludeLegend
    #>
    [cmdletbinding(
    ...
    End {
        If ($Data[0] -is [array]) {
            ...
            ForEach ($Item in $Data) {
                ...
                $Series.ChartType = $ChartTypes::CandleStick
                $Chart.Series.Add($Series)            
                #region MSChart Build
                $Chart.Series[$SeriesLabel].Points.DataBindXY($HashTable.Keys, $HashTable.Values)
                $Chart.Series[$SeriesLabel]['CandleStickLabelStyle'] = 'Outside'
                $Chart.Series[$SeriesLabel]['PixelPointWidth'] = 50
        ...
        Else {
            ...
            $Chart.Series['Series1']['CandleStickLabelStyle'] = 'Outside'
