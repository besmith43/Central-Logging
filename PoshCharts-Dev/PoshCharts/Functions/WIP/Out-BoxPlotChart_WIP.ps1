Function Out-BoxPlotChart {
    <#
        ...
        .EXAMPLE
            ...
            Select-Object -First 10 | Out-BoxPlotChart -XField Name `
        ...
        .EXAMPLE
            ...
            @($Process1,$Process2) | Out-BoxPlotChart -XField Name `
        ...
        .EXAMPLE
            ...
            Sort PercentProcessorTime -Descending  | Select -First 10 | 
            Out-BoxPlotChart -XField Name -YField PercentProcessorTime -Title 'Top 10 Processes By CPU Usage (if applicable)' -IncludeLegend
    #>
    [cmdletbinding(
    ...
    End {
        ...
        Else {
            ...
            $Chart.Series['Series1']['BoxPlotLabelStyle'] = 'Outside'
