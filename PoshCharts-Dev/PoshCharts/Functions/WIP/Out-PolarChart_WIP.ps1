Function Out-PolarChart {
    <#
        ...
        .EXAMPLE
            ...
            Select-Object -First 10 | Out-PolarChart -XField Name `
        ...
        .EXAMPLE
            ...
            @($Process1,$Process2) | Out-PolarChart -XField Name `
        ...
        .EXAMPLE
            ...
            Sort PercentProcessorTime -Descending  | Select -First 10 | 
            Out-PolarChart -XField Name -YField PercentProcessorTime -Title 'Top 10 Processes By CPU Usage (if applicable)' -IncludeLegend
    #>
    [cmdletbinding(
    ...
    End {
        ...
        Else {
            ...
            $Chart.Series['Series1']['PolarLabelStyle'] = 'Outside'
