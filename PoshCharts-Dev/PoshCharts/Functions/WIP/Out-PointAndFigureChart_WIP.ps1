Function Out-PointAndFigureChart {
    <#
        .SYNOPSIS
        ...
        .EXAMPLE
            ...
            Select-Object -First 10 | Out-PointAndFigureChart -XField Name `
        ...
        .EXAMPLE
            ...
            Out-PointAndFigureChart -XField Name -YField PercentProcessorTime -Title 'Top 10 Processes By CPU Usage (if applicable)' -IncludeLegend
    #>
    [cmdletbinding(
    ...
    Begin {
        ...
        $Series.ChartType = $ChartTypes::PointAndFigure
